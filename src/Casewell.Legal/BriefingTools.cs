    ...
    ISmtpTransport smtp)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        db.MatterDocuments.Add(new MatterDocument
        {
            ...
            Note = "client status update (AI-drafted, awaiting attorney review)",
        });
    ...
    /// <summary>
    /// The ABA 5.3 disclosure. It must say the draft is AI-generated, not merely that it is a
    /// draft: the supervising attorney's duty attaches to work the assistant produced, and a bare
    /// "DRAFT" banner does not tell the reviewer which kind of scrutiny this document needs.
    /// Stripped from the client copy at send time — by then a human has approved it, and that
    /// approval is the review record.
    /// </summary>
    public const string DraftBanner =
        "AI-DRAFTED — generated by the Casewell assistant and NOT yet reviewed. " +
        "An attorney must review and approve this letter before it is sent to the client.";
